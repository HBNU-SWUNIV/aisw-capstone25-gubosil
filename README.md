  ...
  - ### Description
    - ### 실험 환경 구성
      - 두 대의 라즈베리파이를 사용하여, 하나는 트래픽을 생성하는 송신 장치로, 다른 하나는 AI 기반 이상 탐지 시스템으로 구성하였다.
          ...
          > 라즈베리파이는 실제 IoT 환경을 가정하여 저전력·소형 하드웨어에서의 실시간 동작 가능성을 검증하기 위해 사용되었다. <img width="528" height="250" alt="Images" src="https://github.com/user-attachments/assets/01cf1670-470c-429e-8453-a399beeaec65" />
